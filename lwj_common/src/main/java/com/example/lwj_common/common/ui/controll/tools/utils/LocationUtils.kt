...
import com.example.lwj_common.common.ui.controll.tools.utils.LocationUtils.LocationCallBack
import androidx.core.app.ActivityCompat
import android.content.pm.PackageManager
import android.location.Location
import com.example.lwj_common.common.ui.controll.tools.utils.LocationUtils.GetLastLocation
...
//            context.startActivityForResult(intent, 0);
        ...
        try {
            network_enabled =
                lm!!.isProviderEnabled(LocationManager.NETWORK_PROVIDER) //没有google服务的手机,返回false
            if (!network_enabled) {
        ...
        if (gps_enabled) lm!!.requestLocationUpdates(LocationManager.GPS_PROVIDER,
            0,
            0f,
            locationListenerGps)
        if (network_enabled) lm!!.requestLocationUpdates(LocationManager.NETWORK_PROVIDER,
            0,
            0f,
